...
for (j in 1:nvar) {
      ...
      load(file = file.path(path_out, var.predict[j], paste(var.predict[j], "_TUNE_200", ".rdata", sep = "")))
      ...
      save(Built.rf.L, file = file.path(path_out, var.predict[j], paste(var.predict[j], "_BUILT_200", ".rdata", sep = "")))
      ...
      save(varImp.norm.L, file = file.path(path_out,var.predict[j], paste(var.predict[j],"_BUILT_varImp_200", ".rdata", sep = "")))
} # end of j loop
